...
const categories = [
  {
    ...
    products: [
      { img: '/cat-ferramentas.jpg',                        name: 'Chave de Boca',                             brand: BRAND_KROFTOOLS, sub: 'Ferramenta Manual' },
      { img: '/products/krof-chave-boca-luneta.jpg',        name: 'Chave de Boca Luneta',                      brand: BRAND_KROFTOOLS, sub: 'Ferramenta Manual' },
      { img: '/products/jbm-extensor-chaves.jpg',           name: 'Extensor Universal de Chaves 340mm',        brand: BRAND_JBM,       sub: 'Ferramenta Manual' },
      { img: '/products/jbm-chaves-torx.jpg',               name: 'Conjunto de Chaves Torx Coloridas',         brand: BRAND_JBM,       sub: 'Ferramenta Manual' },
      { img: '/products/jbm-carro-ferramentas.jpg',         name: 'Carro de Ferramentas XL 8 Gavetas',         brand: BRAND_JBM,       sub: 'Equipamento de Oficina' },
    ],
    subcategories: [
  ...
  },
  {
    ...
    products: [
      { img: '/cat-mecanica.jpg',                     name: 'Anilhas Injetor Cobre',                   brand: BRAND_KROFTOOLS, sub: 'Ferramenta Específica' },
      { img: '/products/krof-bits.jpg',               name: 'Bits de Alta Resistência',                brand: BRAND_KROFTOOLS, sub: 'Ferramenta Específica' },
      { img: '/products/jbm-macaco-hidraulico.jpg',   name: 'Macaco Hidráulico 3T Baixo Perfil',       brand: BRAND_JBM,       sub: 'Ferramentas Hidráulicas' },
      { img: '/products/jbm-carretel-oleo.jpg',       name: 'Carretel de Mangueira para Óleo 15m',     brand: BRAND_JBM,       sub: 'Lubrificação' },
    ],
    subcategories: [
  ...
  },
  {
    ...
    products: [
      { img: '/cat-chapa.jpg',                        name: 'Saca Molas de Portas',                    brand: BRAND_KROFTOOLS, sub: 'Reparação de Carroçaria' },
      { img: '/products/krof-kit-farois.jpg',         name: 'Kit Restauração de Faróis',               brand: BRAND_KROFTOOLS, sub: 'Restauração de Faróis' },
      { img: '/products/krof-agulha-parabrisa.jpg',   name: 'Agulha p/ Fio Cortar Para-Brisas',        brand: BRAND_KROFTOOLS, sub: 'Substituição de Vidros' },
      { img: '/products/jbm-kit-amolgadelas.jpg',     name: 'Kit Reparação de Amolgadelas 11 pcs',     brand: BRAND_JBM,       sub: 'Reparação de Carroçaria' },
      { img: '/products/jbm-ventosa.jpg',             name: 'Ventosa de Extração Ø70mm',               brand: BRAND_JBM,       sub: 'Reparação de Carroçaria' },
    ],
    subcategories: [
  ...
  },
  {
    ...
    products: [
      { img: '/cat-higiene.jpg',                  name: 'Luvas PU de Proteção Mecânica',          brand: BRAND_KROFTOOLS, sub: 'EPI' },
      { img: '/products/jbm-luvas-nitrilo.jpg',   name: 'Luvas de Nitrilo Descartáveis (100 un.)',brand: BRAND_JBM,       sub: 'EPI' },
      { img: '/products/jbm-colete.jpg',           name: 'Colete de Trabalho Cinzento-Preto',      brand: BRAND_JBM,       sub: 'Vestuário Profissional' },
    ],
    subcategories: [
  ...
  },
  {
    ...
    products: [
      { img: '/cat-eletricidade.jpg',           name: 'Gambiarra 5W LED com Carregador',         brand: BRAND_KROFTOOLS, sub: 'Iluminação Profissional' },
      { img: '/products/jbm-lanterna.jpg',      name: 'Lâmpada LED de Bolso 120LM',              brand: BRAND_JBM,       sub: 'Iluminação Profissional' },
      { img: '/products/jbm-foco-solar.jpg',    name: 'Foco LED Portátil Imantado Solar 800LM',  brand: BRAND_JBM,       sub: 'Iluminação Profissional' },
    ],
    subcategories: [
  ...
  },
  {
    ...
    products: [
      { img: '/products/jbm-carretel-mangueira.jpg', name: 'Carretel de Mangueira de Água 15+1.5m',  brand: BRAND_JBM,    sub: 'Equipamento de Lavagem' },
      { img: null,                                    name: 'Champô Automóvel Profissional',           brand: BRAND_TAYSIL, sub: 'Limpeza Exterior' },
      { img: null,                                    name: 'Desengordurante Universal em Spray',      brand: BRAND_TAYSIL, sub: 'Limpeza Exterior' },
      { img: null,                                    name: 'Limpa-Jantes Concentrado',                brand: BRAND_TAYSIL, sub: 'Limpeza Exterior' },
      { img: null,                                    name: 'Microfibras de Lavagem (Pack 10)',         brand: BRAND_TAYSIL, sub: 'Consumíveis de Lavagem' },
    ],
    subcategories: [
...
const ProductCard = ({ img, name, brand, sub, iconBg, Icon }) => (
  <div className="bg-white border border-slate-100 rounded-xl p-4 flex flex-col items-center text-center gap-2.5 hover:shadow-md hover:border-slate-200 transition-all">
    {img ? (
                  ...
                  <div className={`border-t-2 ${accent} px-6 pb-8 pt-6 space-y-8`}>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3">
                        {products.map((p) => (
                          <ProductCard key={p.name} {...p} iconBg={iconBg} Icon={Icon} />
                        ))}
                      </div>
                    </div>
                    ...
                    <div>
                      <p className="text-xs font-semibold uppercase tracking-widest text-slate-400 mb-4">O que encontra nesta categoria</p>
