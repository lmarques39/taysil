...
export const PRODUCTS: Product[] = [
  ...
  { id: 't-l-01', name: 'Champô Automóvel Profissional', brand: 'TAYSIL', category: 'lavagens', sub: 'Limpeza Exterior', img: '/products/taysil-champo.jpg', desc: 'Champô de alta espuma para lavagem manual. Formulação pH neutro, seguro em ceras e revestimentos cerâmicos.' },
  { id: 't-l-02', name: 'Desengordurante Universal em Spray', brand: 'TAYSIL', category: 'lavagens', sub: 'Limpeza Exterior', img: '/products/taysil-desengordurante.jpg', desc: 'Desengordurante em spray para remoção de óleo, graxa e betume em motor, jantes e carroçaria. Seguro em plásticos.' },
  { id: 't-l-03', name: 'Limpa-Jantes Concentrado', brand: 'TAYSIL', category: 'lavagens', sub: 'Limpeza Exterior', img: '/products/taysil-limpa-jantes.jpg', desc: 'Produto concentrado para limpeza profunda de jantes em liga leve e aço. Remove pó de travão e sujidade acumulada.' },
  { id: 't-l-04', name: 'Microfibras de Lavagem (Pack 10)', brand: 'TAYSIL', category: 'lavagens', sub: 'Consumíveis de Lavagem', img: '/products/taysil-microfibras.jpg', desc: 'Pack de 10 panos de microfibra 40×40 cm para secagem e polimento. Alta absorção, laváveis a 60 °C.' },
]
